...
(function smartypants_ProcessEscapes (str)
	(set str ((regex ("\\\\ " substringToIndex:4)) replaceWithString:"&#92;" inString:str)) ; Hack because Nu can't escape backslashes
		; Can't figure out how to properly escape the following sequence:
	...
	(tokens each: (do (token)
		...
		(else
			...
			(if (== in_pre 0)
				...
				(set value ((regex "\. ?\. ?\. ?") replaceWithString:"&#8230;" inString:value)) ; Educate ellipses
